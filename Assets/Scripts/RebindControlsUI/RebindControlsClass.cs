...
namespace UnityEngine.InputSystem.Samples.RebindUI
{
    ...
    /// </summary>
    public class RebindControlsClass : MonoBehaviour
    {
        /// <summary>
        ...
        public bool ResolveActionAndBinding(out InputAction action, out int bindingIndex)
        {
            ...
            bindingIndex = action.bindings.IndexOf(x => x.id.ToString() == m_BindingId);            if (bindingIndex >= 0)
                return true;
        ...
        public void SwapBinding( RebindControlsClass
 other)
        {
            if (this == other)
        ...
        {
            m_Action.action.Disable(); //Modificado
        ...
        private void PerformInteractiveRebind(InputAction action, int bindingIndex, bool allCompositeParts = false)
        {
            ...
            void CleanUp()
            {
                m_Action.action.Enable(); //Modificado
        ...
        protected void OnEnable()
        {
            if (s_RebindActionUIs == null)
                s_RebindActionUIs = new List<RebindControlsClass>();
        ...
        private static List<RebindControlsClass> s_RebindActionUIs;
        ...
        [Serializable]
        public class UpdateBindingUIEvent : UnityEvent<RebindControlsClass, string, string, string>
        {
        }

        [Serializable]
        public class InteractiveRebindEvent : UnityEvent<RebindControlsClass, InputActionRebindingExtensions.RebindingOperation>
        {
        }
    }
}
